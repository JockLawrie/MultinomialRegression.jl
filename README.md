...
isapprox(pmean, 0.9754110613097936; atol=1e-10)  # Reproducible result
...
isapprox(pmean, 0.9297114521720717; atol=1e-10)
...
isapprox(pmean, 0.8766776511261702; atol=1e-10)
isapprox(B, B2; atol=1e-10)
```